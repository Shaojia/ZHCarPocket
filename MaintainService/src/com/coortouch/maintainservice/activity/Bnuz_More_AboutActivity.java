...
public class Bnuz_More_AboutActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.bnuz_more_about);
	...
	private void setData() {
		...
		wcfService.getAbout(new GetOneRecordListener<BnuzTHelper>() {
